...
public class PhysicsObject : MonoBehaviour
{
    ...
    protected Rigidbody2D rb2d; // rigidbody of parent object
    protected Vector2 velocity;
    protected ContactFilter2D contactFilter;
    protected RaycastHit2D[] hitBuffer = new RaycastHit2D[16];  
    protected List<RaycastHit2D> hitBufferList = new List<RaycastHit2D>(16);   // everything the raycast hits will be stored in here
    ...
    protected virtual void ComputeVelocity() { } // Populated by sub-class, e.g. our "PlayerController" script.
